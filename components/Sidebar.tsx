...
interface SidebarProps {
  userAvatar: string;
  onOpenSettings: () => void;
  activeTab: 'chats' | 'contacts' | 'favorites';
  onTabChange: (tab: 'chats' | 'contacts' | 'favorites') => void;
  onOpenAbout: () => void;
}
  ...
  return (
    <div className="w-[60px] h-full bg-[#2e2e2e] flex flex-col items-center py-6 flex-shrink-0 z-20">
      ...
      <div className="flex flex-col gap-6 w-full items-center">
        ...
        {/* Version Intro / About Icon (Triggers Popup) */}
        <div 
            className="cursor-pointer relative group transition-colors text-gray-400 hover:text-white"
            onClick={onOpenAbout}
            title="软件介绍"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
